...
public class UspesnoLogovanje {
	public static void main(String[] args) {
		try {
			...
			System.out.println("TestUspesan - korisnik se uspesno ulogovao");
		}
	}
}
